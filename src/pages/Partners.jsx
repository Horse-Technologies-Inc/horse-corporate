  ...
  return (
    <div className="pt-[85px] max-sm:pt-[47px] overflow-x-clip">
      <div className="relative">
        ...
        <p className="font-inter font-[600] text-[64px] tracking-[5%] max-md:text-[40px] leading-[80px] absolute max-sm:top-[130px] max-sm:left-[260px] max-md:top-[200px] max-md:left-[460px] md:top-[230px] md:left-[470px] lg:top-[320px] lg:left-[680px] xl:top-[500px] xl:left-[20px]">
          {' '}
          Partners
        </p>
      </div>
      ...
      <div className="container">
        <p className="font-inter font-[600] text-3xl max-sm:text-2xl tracking-[5%] my-8">
