  ...
  return (
    <div className="pt-[85px] max-sm:pt-[47px]">
      ...
      <div className="container">
        <p className="mt-[30px] text-[20px] leading-[40px] font-inter tracking-[5%] mx-[15px] mb-[35px]">
        ...
        <p className="text-[20px] leading-[40px] font-inter tracking-[5%] mx-[15px] mb-[60px]">
        ...
        <p className="text-[20px] leading-[40px] font-inter tracking-[5%] mx-[15px] mb-[35px]">
        ...
        <div className="flex mt-24">
          <button className="hero-btn bg-black rounded-[40px] md:px-[100px] md:mx-auto md:py-[5px] font-inter font-[600] mb-[200px]">
            Contact our team
          </button>
        </div>
      </div>
